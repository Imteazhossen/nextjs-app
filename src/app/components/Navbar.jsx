  ...
  return (
    <div className="navbar bg-gradient-to-r from-amber-200 via-white to-amber-200 shadow-md px-4">
      ...
      <div className="navbar-start">
        ...
        <Link
          href="/"
          className="btn btn-ghost normal-case text-2xl font-bold text-amber-700"
        >
          Mr DIY
        </Link>
      </div>
      ...
      <div className="navbar-end">
        {session ? (
          <button
            ...
            className="btn btn-sm rounded-full bg-red-500 text-white hover:bg-red-600 px-5"
          >
            Logout
          </button>
        ) : (
          <Link
            href="/login"
            className="btn btn-sm rounded-full bg-amber-500 text-white hover:bg-lime-700 px-5"
          >
            Login
          </Link>
        )}
